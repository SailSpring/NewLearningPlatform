<template>
  <el-container>
    <el-header class="class_management_header">
      <el-input
        placeholder="课程班名/编号"
        v-model="cateName" style="width: 200px;">
      </el-input>
      <el-button type="primary" size="medium" style="margin-left: 10px" @click="addNewCate">搜索</el-button>
      <el-button type="primary" size="medium" style="margin-left: 10px" @click="addNewCate">添加</el-button>
    </el-header>
    <el-main class="class_management_main">
      <el-table
        ref="multipleTable"
        :data="categories"
        tooltip-effect="dark"
